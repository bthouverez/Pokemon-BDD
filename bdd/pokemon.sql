...
DROP TABLE IF EXISTS detientPokemon, estType, evolueEn, type, attaque, pokemon, dresseur;
...
CREATE TABLE type (
	...
	libelle_type varchar(10) NOT NULL,
	PRIMARY KEY(id_type)
);
...
CREATE TABLE attaque (
	...
	libelle_att varchar(50) NOT NULL,
	id_type int NOT NULL,
	pp_att int NOT NULL,
	puissance_att int NULL,
	precision_att int NOT NULL,
	PRIMARY KEY(id_att),
	FOREIGN KEY(id_type) REFERENCES type(id_type)
);
...
INSERT INTO attaque (id_att, libelle_att, id_type, pp_att, puissance_att, precision_att) VALUES
	(  1, 'Abîme', 			13, 5, 	null, 	30),
	(  2, 'Acidd''armure', 	10, 40, null, 	100),
	...
	( 29, 'Coudd''boule', 	8, 	15, 70, 	100),
	( 30, 'Coudd''krâne', 	8, 	15, 100, 	100),
	( 31, 'Coupe', 			8, 	30, 50, 	95),
	...
	( 55, 'Ecrasd''face', 	8, 	35, 40, 	100),
	( 56, 'Ecume', 			3, 	30, 20, 	100),
	( 57, 'Empald''korne', 	8, 	5, 	null, 	30),
...
INSERT INTO estType (id_pok, id_type) VALUES
	(  1, 9),
	(  1, 10),
	(  2, 9),
	(  2, 10),
